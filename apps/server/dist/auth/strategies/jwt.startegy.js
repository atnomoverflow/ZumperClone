...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, auth_types_1.AuthTypes.JWT) {
    constructor(userService, jwtConf) {
        super({
            usernameField: 'email',
...
exports.JwtStrategy = JwtStrategy = __decorate([
    ...
    __metadata("design:paramtypes", [user_service_1.UserService, void 0])
], JwtStrategy);
