...
<template>
    <div v-if="props.openMenu">
        <div v-if="menuStack.length == 0" class="fixed inset-0 z-20 overflow-y-auto bg-background">
            ...
            <div v-if="!userStore.authenticated" class="flex flex-col mt-10 mb-14 w-full space-y-3">
            ...
            <div v-if="userStore.authenticated" class="flex flex-col mt-10 mb-14 w-full space-y-3">
                <button @click="handelLogout"
                    class="min-w-72 mx-auto p-4 bg-gray-800 font-semibold text-white rounded-lg">Log out</button>
            </div>
        </div>
        <div v-else class="fixed inset-0 z-20 overflow-y-auto bg-background">
